...
class ViewController: UIViewController {
    ...
    @IBAction func calculateButton_TouchUpInside(_ sender: Any) {
        ...
        print("If you save $\(monthly_investment!) every month for \(planned_retirement_age! - current_age!) years, and invest that money plus your current investment of $\(current_savings!) at a \(interest_rate!)% anual interest rate, you will have $\(retirement_amount) by the time you are \(planned_retirement_age!) years old.")
