...
class RetirementCalculatorUITests: XCTestCase {
    ...
    func testExample() {
        ...
        XCTContext.runActivity(named: "screenshot") { (activity) in
            ...
            let result = "If you save $100.0 every month for 35 years, and invest that money plus your current investment of $1000.0 at a 3.0% anual interest rate, you will have $77196.78035159889 by the time you are 65 years old."
